Feature: Kolibri integration testing scenarios
  This is an integration testing suite for Kolibri.
  ...
  Scenario: Android app installation
  	Given that the kolibri app is not installed and running
  	When I download the .apk installer for Kolibri
    	And I tap the Kolibri installer
