...
# Prepare two browsers, or two windows/tabs of the same browser, one of them being incognito/private mode, in order to sign in into one as a learner user, and as a coach in the other
  ...
  Scenario: Review progress before the first learner starts the lesson
    ...
    When as a coach <coach> in another window I go to the *Coach - '<class>' > Lessons > '<lesson>' > Report* subtab
  ...
  Scenario: Learner1 starts the lesson
    ...
    Then within 5 seconds as a coach <coach> in *Coach - '<class>' > Lessons > '<lesson>' > Report* subtab I see *Progress* for <video> is *1 of 3 has started*
    When I go to the *Coach - '<class>' > Lessons > '<lesson>' > Learners* subtab
  ...
  Scenario: Learner1 completes the lesson
    ...
    Then as a coach <coach> in *Coach - '<class>' > Lessons > '<lesson>' > Report* subtab I see *Progress* for <video> is *Completed by 1 of 3*
    When I go to the *Coach - '<class>' > Lessons > '<lesson>' > Learners* subtab
  ...
  Scenario: Learner2 starts the lesson
    When I as a <learner2> click to open the <lesson> lesson
      And I start the <video>
    Then within 5 seconds as a coach <coach> in *Coach - '<class>' > Lessons > '<lesson>' > Report* subtab I see *Progress* for <video> is *Completed by 1 of 3; 1 started*
    When I go to the *Coach - '<class>' > Lessons > '<lesson>' > Learners* subtab
    Then I see the value for progress for <learner1> is *Completed*
  ...
  Scenario: Learner2 completes the lesson
    ...
    Then as a coach <coach> in *Coach - '<class>' > Lessons > '<lesson>' > Report* subtab I see *Progress* for <video> is *Completed by 2 of 3*
    When I go to the *Coach - '<class>' > Lessons > '<lesson>' > Learners* subtab
  ...
  Scenario: Learner3 starts the lesson
    When I as a <learner3> click to open the <lesson> lesson
      And I start the <video>
    Then within 5 seconds as a coach <coach> in *Coach - '<class>' > Lessons > '<lesson>' > Report* subtab I see *Progress* for <video> is *Completed by 2 of 3; 1 started*
    When I go to the *Coach - '<class>' > Lessons > '<lesson>' > Learners* subtab
  ...
  Scenario: Learner3 completes the lesson
    ...
    Then as a coach <coach> in *Coach - '<class>' > Lessons > '<lesson>' > Report* subtab I see *Progress* for <video> is *Completed by all 3*
    When I go to the *Coach - '<class>' > Lessons > '<lesson>' > Learners* subtab
