...
i18n-download-translations:
	...
	yarn exec kolibri-tools i18n-csv-to-json -- --lang-info ./kolibri/locale/language_info.json --pluginFile ./build_tools/build_plugins.txt --ignore '**/node_modules/**','**/static/**'
