...
class ContentMetadataTestCase(TestCase):
    ...
    def test_update_content_copy(self):
        ...
        fm_1 = content.FileFormat.objects.using(self.the_channel_id).get(extension='avi')
        fm_3 = content.FileFormat.objects.using(self.the_channel_id).get(extension='mp4')
        ...
        fm_2 = content.FileFormat.objects.using(self.the_channel_id).get(extension='png')
        ...
        self.assertEqual(file_3.preset.name, 'high_res_video')
