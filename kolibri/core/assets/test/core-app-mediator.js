...
describe('Mediator', function () {
  ...
  describe('language asset registry', function () {
    it('should be empty', function () {
      assert.deepEqual(this.mediator._languageAssetRegistry, {});
    });
  });
  ...
  describe('_registerEvents method', function () {
    it('should not throw a TypeError due to incorrect assignment of this when the eventListenerMethod is called', function () { // eslint-disable-line max-len
      const self = this;
