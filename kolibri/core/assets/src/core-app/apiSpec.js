...
import KNavbarLink from '../views/k-navbar/KNavbarLink';
import CoreLogo from '../views/CoreLogo';
import LanguageSwitcherList from '../views/language-switcher/LanguageSwitcherList.vue';
...
import KGridItem from '../views/KGrid/KGridItem.vue';
