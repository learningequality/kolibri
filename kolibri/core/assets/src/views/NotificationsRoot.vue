<template>
  ...
  <div>
    <AppBarPage v-if="!loading && notAuthorized">
      <KPageContainer>
        <AuthMessage :authorizedRole="authorizedRole" :header="authorizationErrorHeader"
    ...
    <GlobalSnackbar />
    <UpdateNotification v-if="!loading && showNotification && mostRecentNotification" :id="mostRecentNotification.id"
      :title="mostRecentNotification.title" :msg="mostRecentNotification.msg"
      :linkText="mostRecentNotification.linkText" :linkUrl="mostRecentNotification.linkUrl"
