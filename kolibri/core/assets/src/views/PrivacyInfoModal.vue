...
<script>
  ...
  export default {
    ...
    $trs: {
      ...
      kolibriOwnersP3:
        'If you choose to sync your facility data to the Kolibri Data Portal, you are granting access to your data to organization admins on Kolibri Data Portal. It will be uploaded to cloud servers operated by Learning Equality, who will also have access to this data.',
      kolibriOwnersP4:
