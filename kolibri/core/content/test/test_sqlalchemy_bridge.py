...
class SQLAlchemyBridgeClassTestCase(TestCase):
    ...
    @patch('kolibri.core.content.utils.sqlalchemybridge.get_default_db_string', return_value='test')
...
class SQLAlchemyBridgeSQLAlchemyFunctionsTestCase(TestCase):
    ...
    @patch('kolibri.core.content.utils.sqlalchemybridge.sessionmaker', return_value=lambda: 'test_session')
    @patch('kolibri.core.content.utils.sqlalchemybridge.get_engine', return_value='test_engine')
