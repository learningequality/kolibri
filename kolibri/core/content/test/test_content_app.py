...
class ContentNodeAPIBase(object):
    ...
    def test_filter_by_single_included_language(self):
        ...
        response = self.client.get(
            reverse("kolibri:core:contentnode-list"), data={"included_languages": "en"}
        )
    ...
    def test_filter_by_non_existent_language(self):
        ...
        response = self.client.get(
            reverse("kolibri:core:contentnode-list"), data={"included_languages": "fr"}
        )
    ...
    def test_filter_by_multiple_languages_per_node(self):
        ...
        response = self.client.get(
            reverse("kolibri:core:contentnode-list"), data={"included_languages": "es"}
        )
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]["title"], "c1")
    ...
    def test_filter_by_language_subcodes(self):
        ...
        response = self.client.get(
            reverse("kolibri:core:contentnode-list"),
            data={"included_languages": "es-419"},
        )
        self.assertEqual(len(response.data), 1)
        ...
        response = self.client.get(
            reverse("kolibri:core:contentnode-list"),
            data={"included_languages": "es-es,es-419"},
        )
        self.assertEqual(len(response.data), 2)
        titles = {node["title"] for node in response.data}
