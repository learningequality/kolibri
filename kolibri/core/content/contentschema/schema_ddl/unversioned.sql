...
CREATE TABLE content_license (
    ...
    license_description VARCHAR(400),
    PRIMARY KEY (id)
);
...
CREATE UNIQUE INDEX content_contentnode_has_prerequisite_from_contentnode_id_c9e1d527_uniq ON content_contentnode_has_prerequisite (
