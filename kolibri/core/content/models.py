...
class ContentNodeQueryset(TreeQuerySet, FilterByUUIDQuerysetMixin):
    ...
    def has_all_labels(self, field_name, labels):
        ...
        filters = {}
        annotations = {}
        for bitmask_fieldname, field_bits in bits.items():
            ...
            filters[annotation_fieldname] = field_bits
            ...
            annotations[annotation_fieldname] = F(bitmask_fieldname).bitand(field_bits)
