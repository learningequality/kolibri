...
export const TaskTypes = {
  REMOTECHANNELIMPORT: 'kolibri.core.tasks.remotechannelimport',
  REMOTECONTENTIMPORT: 'kolibri.core.tasks.remotecontentimport',
  REMOTEIMPORT: 'kolibri.core.tasks.remoteimport',
  DISKCHANNELIMPORT: 'kolibri.core.tasks.diskchannelimport',
  DISKCONTENTIMPORT: 'kolibri.core.tasks.diskcontentimport',
  DISKIMPORT: 'kolibri.core.tasks.diskimport',
  DISKCONTENTEXPORT: 'kolibri.core.tasks.diskcontentexport',
  DISKEXPORT: 'kolibri.core.tasks.diskexport',
  DELETECHANNEL: 'kolibri.core.tasks.deletechannel',
  UPDATECHANNEL: 'kolibri.core.tasks.updatechannel',
  CHANNELDIFFSTATS: 'kolibri.core.tasks.channeldiffstats',
