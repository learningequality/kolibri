...
export default function useLodDeviceUsers() {
  ...
  /**
   * Fetches the list of users from the facility, optionally forcing a refresh.
   * @param {object} root0 - Options object.
   * @param {boolean} root0.force - Whether to bypass the cache and force a fresh fetch.
   * @returns {Promise<void>} Resolves when the users have been fetched.
   */
  ...
  /**
   * Removes an imported user from the facility by user ID.
   * @param {string} userId - The ID of the user to remove.
   * @returns {Promise<boolean>} True on success, false if removal fails or user cannot be removed.
   */
  ...
  /**
   * Resets the cannot-remove-user warning flag.
   * @returns {void}
   */
