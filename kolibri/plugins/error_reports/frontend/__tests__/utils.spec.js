...
// Envelope shape is asserted end-to-end in index.spec.js; these cover only the
// per-class construction branches awkward to reach through the global handlers.
describe('utils', () => {
  ...
  describe('route context', () => {
    ...
    it('should report a null route context when reading the route throws', () => {
      // _getRouteContext swallows a router that is not ready yet rather than
      // letting the capture itself fail.
