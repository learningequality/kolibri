...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.sandbox.on(events.LOADING, isLoading => {
        channelLoaded = channelLoaded || !isLoading;
      });
      ...
      // for its preset; Html5ZipHandler's Kolibri shim is what supplies window.kolibri.
