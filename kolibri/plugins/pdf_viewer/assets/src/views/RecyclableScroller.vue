  ...
  export default {
    ...
    methods: {
      ...
      handleVisibilityChange (isVisible, entry) {
        if (this.ready) {
          if (isVisible || entry.boundingClientRect.width !== 0 || 
      ...
      updateVisibleItems (checkItem, checkPositionDiff = false) {
        ...
        if (!count) {
          ...
          if (itemSize === null) {
            ...
            for (endIndex = i; endIndex < count && 
              sizes[endIndex].accumulator < scroll.end; endIndex++);
            if (endIndex === -1) {
            ...
            for (visibleStartIndex = startIndex; visibleStartIndex < count && 
              (beforeSize + sizes[visibleStartIndex].accumulator) < scroll.start;
              visibleStartIndex++);
  
            // search visible endIndex
            for (visibleEndIndex = visibleStartIndex; visibleEndIndex < count && 
      ...
      getListenerTarget () {
        ...
        if (window.document && (target === window.document.documentElement
