...
/**
 * Composable providing quiz creation state and actions.
 * @returns {object} Quiz creation state and action methods.
 */
export default function useQuizCreation() {
  ...
  /**
   * Clears all currently selected question IDs.
   * @returns {void}
   */
...
/**
 * Injects the quiz creation context provided by a parent component using useQuizCreation.
 * @returns {object} All injected quiz creation state and action methods.
 */
