<template>
  ...
  <div class="wrapper">
    ...
    <section>
      <h1>
        {{ string('AnalyzeQuizReports', 'header') }}
      </h1>
      <p>
        {{ string('AnalyzeQuizReports', 'p1') }}
      </p>
      <ul>
        <li>
          {{ string('AnalyzeQuizReports', 'list_1_item_1') }}
        </li>
      </ul><ul>
        <li>
          {{ string('AnalyzeQuizReports', 'list_1_item_1_subitem_1') }}
        </li>
        <li>
          {{ string('AnalyzeQuizReports', 'list_1_item_1_subitem_2') }}
        </li>
        <li>
          {{ string('AnalyzeQuizReports', 'list_1_item_1_subitem_3') }}
        </li>
      </ul><ul>
        <li>
          {{ string('AnalyzeQuizReports', 'list_1_item_2') }}
        </li>
      </ul>
      <p>
        {{ string('AnalyzeQuizReports', 'p2') }}
      </p>
      <ul>
        <li>
          {{ string('AnalyzeQuizReports', 'list_2_item_1') }}
        </li>
        <li>
          {{ string('AnalyzeQuizReports', 'list_2_item_2') }}
        </li>
      </ul>
      <p>
        {{ string('AnalyzeQuizReports', 'p3') }}
      </p>
      <ul>
        <li>
          {{ string('AnalyzeQuizReports', 'list_3_item_1') }}
        </li>
        <li>
          {{ string('AnalyzeQuizReports', 'list_3_item_2') }}
        </li>
        <li>
          {{ string('AnalyzeQuizReports', 'list_3_item_3') }}
        </li>
      </ul>
    </section>
    ...
    <section>
      <h1>
        {{ string('AnalyzeGroupReports', 'header') }}
      </h1>
      <p>
        {{ string('AnalyzeGroupReports', 'p1') }}
      </p>
      <ul>
        <li>
          {{ string('AnalyzeGroupReports', 'list_1_item_1') }}
        </li>
        <li>
          {{ string('AnalyzeGroupReports', 'list_1_item_2') }}
        </li>
        <li>
          {{ string('AnalyzeGroupReports', 'list_1_item_3') }}
        </li>
      </ul>
      <p>
        {{ string('AnalyzeGroupReports', 'p2') }}
      </p>
      <ul>
        <li>
          {{ string('AnalyzeGroupReports', 'list_2_item_1') }}
        </li>
        <li>
          {{ string('AnalyzeGroupReports', 'list_2_item_2') }}
        </li>
        <li>
          {{ string('AnalyzeGroupReports', 'list_2_item_3') }}
        </li>
      </ul>
    </section>
  </div>
...
<script>
  ...
  strings['AnalyzeQuizReports'] = createTranslator('AnalyzeQuizReports', {
    header: 'Analyze Quiz reports',
    p1: 'Observe and Analyze',
    list_1_item_1: 'What are some patterns that are emerging?',
    list_1_item_1_subitem_1: 'How many learners scored above your expected goal?',
    list_1_item_1_subitem_2: 'How many learners scored below your expected goal?',
    list_1_item_1_subitem_3: 'How many learners met your expected goal?',
    list_1_item_2: 'What seems to be surprising or unexpected?',
    p2: 'Use the data to inform student learning needs',
    list_2_item_1:
      'Have individual conversations with learners to address questions and motivate them on their next steps.',
    list_2_item_2: 'Adjust their learning needs and assign further resources accordingly.',
    p3: 'Set goals based on the data',
    list_3_item_1:
      'What goals do you need to set for your learners based on their needs and their mastery?',
    list_3_item_2: 'Are there different goals for different learners?',
    list_3_item_3: 'How will you achieve these goals?',
  });
  ...
  strings['AnalyzeGroupReports'] = createTranslator('AnalyzeGroupReports', {
    ...
    p2: 'Set goals based on the data',
    list_2_item_1:
      'What goals do you need to set for your groups based on their needs and their mastery?',
    list_2_item_2: 'Are there different goals for different groups?',
    list_2_item_3: 'How will you achieve these goals?',
  });
