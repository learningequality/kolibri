<template>
  ...
  >
    <h1>ReportsGroupReportLessonPracticeQuizLearnerPage</h1>
...
<script>
  ...
  export default {
    name: 'ReportsGroupReportLessonPracticeQuizLearnerPage',
    // components: {
    //   LearnerExerciseReport,
    // },
    // mixins: [commonCoach],
    ...
    //     return backRoute ||
    // this.classRoute('ReportsGroupReportLessonExerciseLearnerListPage', {});
    //   },
    // },
    // methods: {
