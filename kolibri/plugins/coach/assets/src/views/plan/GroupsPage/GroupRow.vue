...
<script>
  ...
  export default {
    ...
    computed: {
      menuOptions() {
        return [this.common$tr('renameAction'), this.common$tr('deleteAction')];
      },
    },
    methods: {
      handleSelection(selectedOption) {
        let emitted;
        if (selectedOption === this.common$tr('renameAction')) {
          emitted = 'rename';
        } else if (selectedOption === this.common$tr('deleteAction')) {
          emitted = 'delete';
        }
