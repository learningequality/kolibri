...
export default createTranslator('MediaPlayerStrings', {
  ...
  playbackRateWithValue: {
    message: 'Playback rate: {rate, number}×',
    context:
      'Accessible label for the button that changes media playback speed, including the current speed, e.g. "Playback rate: 1.5×".',
  },
  playbackRateLabel: {
    message: '{rate, number}×',
    context: 'Label showing the current playback speed multiplier, e.g. "1.5×".',
  },
  progressBar: {
  ...
  // Transcript toggle (AudioPlayer) — display casing is applied via CSS text-transform
  showTranscript: {
