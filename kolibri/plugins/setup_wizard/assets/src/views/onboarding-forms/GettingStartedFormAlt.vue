  ...
  export default {
    ...
    $trs: {
      ...
      descriptionParagraph1: {
        message:
          'Kolibri can use facilities to manage larger groups of users. This can be useful in schools, educational programs and other group learning settings.',
      ...
      configureFacilityAction: {
        ...
        context: 'Button that takes user to more advanced device and facility configuration steps',
      },
      skipAction: {
        message: 'Skip',
