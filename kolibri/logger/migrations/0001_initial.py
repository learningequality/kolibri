    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_id', kolibri.content.models.UUIDField(db_index=True, max_length=32)),
                ('channel_id', kolibri.content.models.UUIDField(db_index=True, max_length=32)),
                ('start_timestamp', models.DateTimeField(auto_now_add=True)),
                ('completion_timestamp', models.DateTimeField(blank=True, null=True)),
                ('item_session', kolibri.content.models.UUIDField(max_length=32)),
