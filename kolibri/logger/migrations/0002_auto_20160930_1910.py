# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-09-30 19:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complete', models.BooleanField(default=False)),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kolibriauth.FacilityDataset')),
                ('summarylog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='logger.ContentSummaryLog')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='masterylog',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='logger.MasteryLog'),
        ),
    ]
