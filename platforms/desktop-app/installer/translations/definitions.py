...
# update_from_inno.py. Omit when Inno has no translation for the language.
...
LANG_DEFINITIONS = {
    ...
    # --- Related-Language Inno Translations ---
    # Inno has no es-419 or pt-mz file, so the nearest locale's official one supplies
    # [Messages]. Crowdin must not also translate them: it exports untranslated
    # strings as source text, which would put English back over the Spanish.
    "es-419": {
        "inno_file": "Languages/Spanish.isl",
        "id": "$580A",
