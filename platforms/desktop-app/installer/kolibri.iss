...
[Languages]
; Written by translations/write_language_files.py from definitions.py (make
; installer-language-files), which the build runs before iscc.
#include "translations\languages.iss"
