...
OIDC_OP_AUTHORIZATION_ENDPOINT = (
    OIDC_OPTIONS["AUTHORIZATION_ENDPOINT"] or f"{OIDC_URL}/authorize"
)
OIDC_OP_JWKS_ENDPOINT = OIDC_OPTIONS["JWKS_URI"] or f"{OIDC_URL}/jwks"
OIDC_OP_TOKEN_ENDPOINT = OIDC_OPTIONS["TOKEN_ENDPOINT"] or f"{OIDC_URL}/token"
OIDC_OP_USER_ENDPOINT = OIDC_OPTIONS["USERINFO_ENDPOINT"] or f"{OIDC_URL}/userinfo"
