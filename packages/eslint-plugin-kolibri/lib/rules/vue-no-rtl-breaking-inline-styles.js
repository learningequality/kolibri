...
function isRtlAwareTernary(node) {
  ...
  /**
   * Checks whether a test node references the isRtl identifier.
   * @param {object} testNode - AST node to inspect.
   * @returns {boolean} True if isRtl is referenced.
   */
...
module.exports = {
  ...
  create(context) {
    return utils.defineTemplateBodyVisitor(context, {
       ...
       * @param {object} node - VAttribute AST node for the style attribute.
       * @returns {void}
       */
       ...
       * @param {object} node - VExpressionContainer AST node for the style binding.
       * @returns {void}
       */
