...
const ObjectTypeChoices = new Set(Object.values(OBJECT_TYPES));
...
const InteractionTypeChoices = new Set(Object.values(INTERACTION_TYPES));

const interactionOptionsLookup = {
...
export default class xAPI extends BaseShim {
  ...
  iframeInitialize() {
    this.__setXAPIWrapperInterface();
  }

  __setXAPIWrapperInterface() {
    const self = this;
    ...
    this.xAPIWrapper = new Shim();

    return this.xAPIWrapper;
  }
}
