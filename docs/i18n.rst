...
It is recommended to use the ``KIcon`` component when possible, as this will handle RTL flipping for you and apply it when appropriate:
...
.. code-block:: html
  ...
  <img src="forward.png" :class="{ 'is-rtl': isRTL }" />
