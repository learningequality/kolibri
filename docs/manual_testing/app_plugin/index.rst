...
By running the command: `pnpm app-python-devserver` you will start Kolibri in development mode. You can also run `pnpm app-devserver` to run the frontend devserver in parallel.
